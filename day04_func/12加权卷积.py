...
mp.plot(dates[9:], ma10, color='black', alpha=0.8, label='MA-10', linewidth=1)
...
ma53 = np.convolve(closeing_prices, kernel, 'valid')
mp.plot(dates[4:], ma53, color='red', label='MA-53', linewidth=2)
